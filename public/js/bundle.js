...
var comment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_comment, postId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Comment added successfully!');
            }
  ...
  return function comment(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var newPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(title, body) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function newPost(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/posts/".concat(id)
            });
...
},{"axios":"../node_modules/axios/index.js","./alerts":"alerts.js"}],"friend.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendReq = exports.rejectReq = exports.deleteFriend = exports.acceptReq = void 0;
...
var acceptReq = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(reqId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/friends/acceptFriend/".concat(reqId)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Request accepted successfully!');
            }
...
var rejectReq = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(reqId) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/friends/rejectFriend/".concat(reqId)
            });
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Request rejected successfully!');
            }
...
var deleteFriend = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(friendId) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/friends/deleteFriend/".concat(friendId)
            });
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Friend deleted successfully!');
            }
  ...
  return function deleteFriend(_x4) {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password, passwordConfirm, token) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var forgotPasswordForm = document.querySelector('.form--password');
var resetPasswordForm = document.querySelector('.form-reset-password');
var logOutBtn = document.querySelector('#logout-btn');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var commentPostForm = document.querySelector('.form-post-comment');
var deleteCommentBtn = document.querySelectorAll('.delete-comment');
var newPostForm = document.querySelector('.new__post-form');
var deletePostBtn = document.getElementById('delete-post');
var sendReqBtn = document.querySelector('.add-friends');
var acceptReqBtn = document.getElementById('accept-req');
var rejectReqBtn = document.getElementById('reject-req');
var deleteFriendBtn = document.querySelector('.remove-friends'); // DELEGATION
...
if (newPostForm) {
  newPostForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var title = document.querySelector('.new__post-title').value;
    var body = document.querySelector('.new__post-body').value;
    (0, _post.newPost)(title, body);
  });
}
