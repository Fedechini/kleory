                    ...
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 4:
                        ...
                        if (res.data.status === 'success') {
                          (0, _alerts.showAlert)(
                            'success',
                            ''.concat(action.toUpperCase(), ' succesfull')
                          );
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'POST',
                          url: 'http://127.0.0.1:3000/api/v1/posts/'.concat(
                            postId,
                            '/comments'
                          ),
                          data: {
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'DELETE',
                          url: 'http://127.0.0.1:3000/api/v1/comments/'.concat(
                            commentId
                          ),
                        });
    ...
    'friend.js': [
      function (require, module, exports) {
        ...
        var sendReq = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(userId) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1) {
        ...
        var acceptReq = /*#__PURE__*/ (function () {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(reqId) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee2$(_context2) {
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: 'http://127.0.0.1:3000/api/v1/friends/acceptFriend/'.concat(
                            reqId
                          ),
                        });
        ...
        var rejectReq = /*#__PURE__*/ (function () {
          var _ref3 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(reqId) {
              var res;
              return _regeneratorRuntime().wrap(
                  ...
                  while (1) {
                    switch ((_context3.prev = _context3.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'DELETE',
                          url: 'http://127.0.0.1:3000/api/v1/friends/rejectFriend/'.concat(
                            reqId
                          ),
                        });
                  ...
                  while (1) {
                    switch ((_context4.prev = _context4.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'DELETE',
                          url: 'http://127.0.0.1:3000/api/v1/friends/deleteFriend/'.concat(
                            friendId
                          ),
                        });
                      ...
                      case 7:
                        ...
                        (0, _alerts.showAlert)(
                          'error',
                          _context4.t0.response.data.message
                        );
