...
})(
  {
                        ...
                        return (
                          ...
                          (a =
                            'login' === i
                              ...
                              : '/api/v1/users/signup'),
                          (e.next = 4),
                          (0, t.default)({ method: 'POST', url: a, data: n })
                        );
                      case 4:
                        'success' === e.sent.data.status &&
                          ((0, r.showAlert)(
                            'success',
                            ''.concat(i.toUpperCase(), ' succesfull')
                          ),
    ...
    CrGO: [
      function (require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.deleteComment = exports.comment = void 0);
        ...
        function o() {
          ...
          return (
            ...
            s(w, 'constructor', d),
            s(d, 'constructor', v),
            (v.displayName = s(d, u, 'GeneratorFunction')),
            (t.isGeneratorFunction = function (t) {
                    ...
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          ...
                          (0, t.default)({
                            method: 'POST',
                            url: '/api/v1/posts/'.concat(i, '/comments'),
                            data: { comment: n },
                          })
                        );
                      case 3:
    ...
    DCbj: [
      function (require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.newPost = exports.deletePost = void 0);
        var t = r(require('axios')),
          e = require('./alerts');
        function r(t) {
          return t && t.__esModule ? t : { default: t };
                    ...
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          ...
                          (0, t.default)({
                            method: 'GET',
                            url: '/api/v1/friends/acceptFriend/'.concat(n),
                          })
                        );
                      case 3:
                        'success' === r.sent.data.status &&
                    ...
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          ...
                          (0, t.default)({
                            method: 'DELETE',
                            url: '/api/v1/friends/rejectFriend/'.concat(n),
                          })
                        );
                      case 3:
                        204 === r.sent.status &&
                    ...
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          ...
                          (0, t.default)({
                            method: 'DELETE',
                            url: '/api/v1/friends/deleteFriend/'.concat(n),
                          })
                        );
                      case 3:
                        204 === r.sent.status &&
                      ...
                      case 0:
                        return (
                          ...
                          (0, t.default)({
                            ...
                            data: { password: n, passwordConfirm: i },
                          })
                        );
                      case 3:
                        'success' === e.sent.data.status &&
    ...
    Focm: [
      function (require, module, exports) {
        ...
        function u() {
          ...
          function l(e, r, t, s) {
            var o = r && r.prototype instanceof j ? r : j,
          ...
          var h = Object.getPrototypeOf,
            q = h && h(h(S([])));
          q && q !== r && t.call(q, o) && (y = q);
          var g = (p.prototype = j.prototype = Object.create(y));
          function v(e) {
            ['next', 'throw', 'return'].forEach(function (r) {
              a(e, r, function (e) {
                ...
                return new r(function (s, u) {
                  !(function s(o, n, u, c) {
                    ...
                    if ('throw' !== a.type) {
                      var l = a.arg,
                        m = l.value;
                      return m && 'object' == i(m) && t.call(m, '__await')
                        ? r.resolve(m.__await).then(
                            function (e) {
                              s('next', e, u, c);
                            },
                            function (e) {
          ...
          function b(e, r) {
            ...
            if ('throw' === s.type)
              return (
                (r.method = 'throw'), (r.arg = s.arg), (r.delegate = null), m
              );
            var o = s.arg;
            return o
              ? o.done
          ...
          return (
            ...
            v(w.prototype),
            a(w.prototype, n, function () {
              return this;
            }),
            (e.AsyncIterator = w),
            (e.async = function (r, t, s, o, n) {
              void 0 === n && (n = Promise);
              var i = new w(l(r, t, s, o), n);
            ...
            (L.prototype = {
              ...
              finish: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  ...
                  if (t.finallyLoc === e)
                    return this.complete(t.completion, t.afterLoc), x(t), m;
                }
              },
              catch: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
        ...
        var l = document.querySelector('.form--login'),
          d = document.querySelector('.form--signup'),
          m = document.querySelector('.form--password'),
          j = document.querySelector('.form-reset-password'),
          f = document.querySelector('#logout-btn'),
          p = document.querySelector('.form-user-data'),
          y = document.querySelector('.form-user-password'),
          h = document.querySelector('.form-post-comment'),
          q = document.querySelectorAll('.delete-comment'),
          g = document.querySelector('.new__post-form'),
          v = document.getElementById('delete-post'),
          w = document.querySelector('.add-friends'),
          b = document.getElementById('accept-req'),
          E = document.getElementById('reject-req'),
          x = document.querySelector('.remove-friends');
        l &&
          l.addEventListener('submit', function (r) {
            r.preventDefault();
            var t = document.getElementById('email').value,
              s = document.getElementById('password').value;
            (0, e.loginSignup)({ email: t, password: s }, 'login');
          }),
          d &&
            d.addEventListener('submit', function (r) {
              r.preventDefault();
              var t = document.getElementById('new-name').value,
                s = document.getElementById('new-email').value,
                o = document.getElementById('new-password').value,
                n = document.getElementById('new-passwordConfirm').value;
              (0,
              e.loginSignup)({ name: t, email: s, password: o, passwordConfirm: n }, 'signup');
            }),
          m &&
            m.addEventListener(
              'submit',
          ...
          j &&
            j.addEventListener('submit', function (e) {
              e.preventDefault();
              var r = document.getElementById('reset-password').value,
                t = document.getElementById('reset-passwordConfirm').value,
                s = window.location.pathname.split('/')[2];
              (0, n.resetPassword)(r, t, s);
            }),
          f && f.addEventListener('click', e.logout),
          p &&
          ...
          h &&
            ...
            h.addEventListener('submit', function (e) {
              e.preventDefault();
              var r = window.location.pathname.split('/')[2],
          ...
          q &&
            q.forEach(function (e) {
              e.addEventListener('click', function (e) {
                var r = e.target.dataset.commentId;
                (0, t.deleteComment)(r);
              });
            }),
          g &&
            g.addEventListener('submit', function (e) {
              e.preventDefault();
              var r = document.querySelector('.new__post-title').value,
                t = document.querySelector('.new__post-body').value;
              (0, s.newPost)(r, t);
            }),
          v &&
      ...
      {
        'core-js/modules/es6.array.copy-within.js': 'tWTB',
        'core-js/modules/es6.array.fill.js': 'hUQ6',
        'core-js/modules/es6.array.filter.js': 'GyG6',
        'core-js/modules/es6.array.find.js': 'Qppk',
        'core-js/modules/es6.array.find-index.js': 'sVmK',
        'core-js/modules/es7.array.flat-map.js': 'I8vV',
        'core-js/modules/es6.array.from.js': 'RRcs',
        'core-js/modules/es7.array.includes.js': 'TLss',
        'core-js/modules/es6.array.iterator.js': 'wVEN',
        'core-js/modules/es6.array.map.js': 'RBsu',
        'core-js/modules/es6.array.of.js': 'RB6b',
        'core-js/modules/es6.array.slice.js': 'btFn',
        'core-js/modules/es6.array.sort.js': 'nrVf',
        'core-js/modules/es6.array.species.js': 'smn3',
        'core-js/modules/es6.date.to-primitive.js': 'jQnQ',
        'core-js/modules/es6.function.has-instance.js': 'a7bX',
        'core-js/modules/es6.function.name.js': 'N3yi',
        'core-js/modules/es6.map.js': 'ioKM',
        'core-js/modules/es6.math.acosh.js': 'py3M',
        'core-js/modules/es6.math.asinh.js': 'ob11',
        'core-js/modules/es6.math.atanh.js': 'iUik',
        'core-js/modules/es6.math.cbrt.js': 'YRuK',
        'core-js/modules/es6.math.clz32.js': 'R2Qc',
        'core-js/modules/es6.math.cosh.js': 'nEse',
        'core-js/modules/es6.math.expm1.js': 'AmoX',
        'core-js/modules/es6.math.fround.js': 'vmlq',
        'core-js/modules/es6.math.hypot.js': 'kLut',
        'core-js/modules/es6.math.imul.js': 'A8J8',
        'core-js/modules/es6.math.log1p.js': 'qtpC',
        'core-js/modules/es6.math.log10.js': 'VUW8',
        'core-js/modules/es6.math.log2.js': 'Jo9J',
        'core-js/modules/es6.math.sign.js': 'mZl9',
        'core-js/modules/es6.math.sinh.js': 'm0zb',
        'core-js/modules/es6.math.tanh.js': 'Fnqw',
        'core-js/modules/es6.math.trunc.js': 'tiOR',
        'core-js/modules/es6.number.constructor.js': 'kRGG',
        'core-js/modules/es6.number.epsilon.js': 'DzYy',
        'core-js/modules/es6.number.is-finite.js': 'FuY7',
        'core-js/modules/es6.number.is-integer.js': 'pwRL',
        'core-js/modules/es6.number.is-nan.js': 'SsgJ',
        'core-js/modules/es6.number.is-safe-integer.js': 'qVIE',
        'core-js/modules/es6.number.max-safe-integer.js': 'shx2',
        'core-js/modules/es6.number.min-safe-integer.js': 'ifBH',
        'core-js/modules/es6.number.parse-float.js': 'yjyf',
        'core-js/modules/es6.number.parse-int.js': 'Guno',
        'core-js/modules/es6.object.assign.js': 'K3Jy',
        'core-js/modules/es7.object.define-getter.js': 'guoQ',
        'core-js/modules/es7.object.define-setter.js': 'HMp9',
        'core-js/modules/es7.object.entries.js': 'gxEP',
        'core-js/modules/es6.object.freeze.js': 'EO7q',
        'core-js/modules/es6.object.get-own-property-descriptor.js': 'nIty',
        'core-js/modules/es7.object.get-own-property-descriptors.js': 'BQD8',
        'core-js/modules/es6.object.get-own-property-names.js': 'i23Y',
        'core-js/modules/es6.object.get-prototype-of.js': 'ud3u',
        'core-js/modules/es7.object.lookup-getter.js': 'HB2g',
        'core-js/modules/es7.object.lookup-setter.js': 'QF5J',
        'core-js/modules/es6.object.prevent-extensions.js': 'llMc',
        'core-js/modules/es6.object.to-string.js': 'zTK3',
        'core-js/modules/es6.object.is.js': 'MlqR',
        'core-js/modules/es6.object.is-frozen.js': 'Z1rp',
        'core-js/modules/es6.object.is-sealed.js': 'Fckj',
        'core-js/modules/es6.object.is-extensible.js': 'EYbC',
        'core-js/modules/es6.object.keys.js': 'm9aB',
        'core-js/modules/es6.object.seal.js': 'GYFR',
        'core-js/modules/es6.object.set-prototype-of.js': 'JGjq',
        'core-js/modules/es7.object.values.js': 'Ltmz',
        'core-js/modules/es6.promise.js': 'Pjta',
        'core-js/modules/es7.promise.finally.js': 'l1j0',
        'core-js/modules/es6.reflect.apply.js': 'F0Xu',
        'core-js/modules/es6.reflect.construct.js': 'JlFO',
        'core-js/modules/es6.reflect.define-property.js': 'S841',
        'core-js/modules/es6.reflect.delete-property.js': 'JRlJ',
        'core-js/modules/es6.reflect.get.js': 'kv8Z',
        'core-js/modules/es6.reflect.get-own-property-descriptor.js': 'zj1X',
        'core-js/modules/es6.reflect.get-prototype-of.js': 'd0aC',
        'core-js/modules/es6.reflect.has.js': 'OWTq',
        'core-js/modules/es6.reflect.is-extensible.js': 'deHu',
        'core-js/modules/es6.reflect.own-keys.js': 'e6SV',
        'core-js/modules/es6.reflect.prevent-extensions.js': 'BmyK',
        'core-js/modules/es6.reflect.set.js': 'K46i',
        'core-js/modules/es6.reflect.set-prototype-of.js': 'L5z5',
        'core-js/modules/es6.regexp.constructor.js': 'BenF',
        'core-js/modules/es6.regexp.flags.js': 'pDhD',
        'core-js/modules/es6.regexp.match.js': 'RTfC',
        'core-js/modules/es6.regexp.replace.js': 'KGao',
        'core-js/modules/es6.regexp.split.js': 'aOHf',
        'core-js/modules/es6.regexp.search.js': 'zOab',
        'core-js/modules/es6.regexp.to-string.js': 'iflU',
        'core-js/modules/es6.set.js': 'coyu',
        'core-js/modules/es6.symbol.js': 'uVn9',
        'core-js/modules/es7.symbol.async-iterator.js': 'DlMC',
        'core-js/modules/es6.string.anchor.js': 'USd7',
        'core-js/modules/es6.string.big.js': 'c1D0',
        'core-js/modules/es6.string.blink.js': 'Ee86',
        'core-js/modules/es6.string.bold.js': 'ry39',
        'core-js/modules/es6.string.code-point-at.js': 'zR9y',
        'core-js/modules/es6.string.ends-with.js': 'zRn7',
        'core-js/modules/es6.string.fixed.js': 'AHLq',
        'core-js/modules/es6.string.fontcolor.js': 'H7V0',
        'core-js/modules/es6.string.fontsize.js': 'Dx83',
        'core-js/modules/es6.string.from-code-point.js': 'xSM3',
        'core-js/modules/es6.string.includes.js': 'fH7p',
        'core-js/modules/es6.string.italics.js': 'fRhg',
        'core-js/modules/es6.string.iterator.js': 'tbKg',
        'core-js/modules/es6.string.link.js': 'Aaz0',
        'core-js/modules/es7.string.pad-start.js': 'SWNE',
        'core-js/modules/es7.string.pad-end.js': 'n20m',
        'core-js/modules/es6.string.raw.js': 't29D',
        'core-js/modules/es6.string.repeat.js': 'C85R',
        'core-js/modules/es6.string.small.js': 'qBr3',
        'core-js/modules/es6.string.starts-with.js': 'w2SA',
        'core-js/modules/es6.string.strike.js': 'eNyu',
        'core-js/modules/es6.string.sub.js': 'BVLK',
        'core-js/modules/es6.string.sup.js': 'kMsL',
        'core-js/modules/es7.string.trim-left.js': 'ppxd',
        'core-js/modules/es7.string.trim-right.js': 'hxx1',
        'core-js/modules/es6.typed.array-buffer.js': 'NJ0a',
        'core-js/modules/es6.typed.int8-array.js': 'wqMZ',
        'core-js/modules/es6.typed.uint8-array.js': 'QTtY',
        'core-js/modules/es6.typed.uint8-clamped-array.js': 'Kqgs',
        'core-js/modules/es6.typed.int16-array.js': 'fEGw',
        'core-js/modules/es6.typed.uint16-array.js': 'xyd6',
        'core-js/modules/es6.typed.int32-array.js': 'hIko',
        'core-js/modules/es6.typed.uint32-array.js': 'tNPN',
        'core-js/modules/es6.typed.float32-array.js': 'wisA',
        'core-js/modules/es6.typed.float64-array.js': 'mbTX',
        'core-js/modules/es6.weak-map.js': 'D6DP',
        'core-js/modules/es6.weak-set.js': 'bRUR',
        'core-js/modules/web.timers.js': 'OTsy',
        'core-js/modules/web.immediate.js': 'hZLH',
        'core-js/modules/web.dom.iterable.js': 'v6Aj',
